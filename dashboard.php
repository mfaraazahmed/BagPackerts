...
// Query to retrieve the last inserted first name
$query = "SELECT `firstName` FROM `FORM` ORDER BY id DESC LIMIT 1";
...
// Use the $lastFirstName variable as needed
// echo "Last Inserted First Name: " . $lastFirstName;
?>
<!DOCTYPE html>
<html lang="en">
<head>
